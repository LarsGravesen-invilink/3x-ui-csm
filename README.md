...
**3X-UI CSM** (Client Subscription Manager) — многофункциональный bash-скрипт для VPS-сервера, который:
...
Один URL → все Ваши серверы → все выбранные инбаунды
...
| Функция | Описание |
|---------|----------|
| **Мульти-сервер** | Добавление одной или нескольких панелей 3x-UI с авторизацией |
| **Выбор инбаундов** | Можно выбрать конкретные инбаунды из каждой панели 3x-UI, ключи из которых будут добавляться в сгенерированную подписку |
...
2. Получает список инбаундов и извлекает VPN-ключи
