...
**3X-UI CSM** — скрипт для VPS, который подключается к одной или нескольким панелям **3x-UI**, собирает VPN-ключи со всех выбранных инбаундов и клиентов, формирует единый файл подписки и раздаёт его через **Nginx** по HTTP или HTTPS
